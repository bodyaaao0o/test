...
export class DashboardPage {
    ...
    getHelloNotificationText(): Locator {
        return this.page.locator('p', { hasText: `Hello ${this.user_name}, You can now start with submitting your first financing request!` }).nth(0);
    };
    ...
    getLogoutNav(): Locator {
        return this.page.locator('div.flex >> text=Logout').nth(1);
    }
